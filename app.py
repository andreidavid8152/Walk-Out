...
from routes.mapa_calor_hospitales import mapa_hospitales_bp
from routes.mapa_pobreza import mapa_pobreza_bp
...
app.register_blueprint(mapa_hospitales_bp)
app.register_blueprint(mapa_pobreza_bp)
